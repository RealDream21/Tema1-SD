...
series7 = [0, 0.001, 0.001, 0.003, 0.005, 0.019, 0.036, 0.185, 0.19, 1.828, 3.424, 17.876, 34.299]
fig = px.line(x=['1e1','1e1-1e2','1e2','1e2-1e3', '1e3','1e3-1e4', '1e4','1e4-1e5', '1e5', '1e5-1e6', '1e6', '1e6-1e7', '1e7'], y=[series1, series2, series3, series4, series5, series6, series7])
newnames = {'wide_variable_0':'myIntrosort', 'wide_variable_1': 'c++ IntroSort', 'wide_variable_2' : 'mergeSort', 'wide_variable_3' : 'radixSort(base 256)', 'wide_variable_4': 'heapSort', 'wide_variable_5' : 'shellSort', 'wide_variable_6' : 'radixSort(base 10)'}
